...
2.And an evil file (backdoor, keylogger ...etc). The result is one exe that when executed, it presents the normal file (file 1) to the user and runs the evil file in the background.
...
2.Install it using wine > wine autoit-v3-setup.exe
3.Clone Trojan Factory: > git clone https://github.com/z00z/TrojanFactory.git
4.You're all set, navigare into TrojanFactory > cd TrojanFactory
5.Run --help for usage > python trojan_factory.py --help
